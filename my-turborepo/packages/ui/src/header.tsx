  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0">
        {/* Main header bar with a higher z-index */}
        <div className="relative z-40 bg-black/50 backdrop-blur-lg border-b border-neutral-800">
        ...
        {/* Scrutineer tab with a lower z-index */}
